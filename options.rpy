...
define config.name = _("I`m Bayron Mental")
...
## aca se pone la musica del menu inicio
define config.main_menu_music = "audio/menu.wav"
...
define config.save_directory = "juego_byron-1697906627"
